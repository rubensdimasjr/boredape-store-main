...
<body>
  ...
  <main>
    <div class="container my-md-5 my-4 grid-container">
      ...
      <div class="price-wrapper">
        <div class="card">
          <div class="card-wrapper m-3 d-flex flex-column">
            <p class="fw-lighter">Preço Atual</p>
            ...
            <a class="btn btn-primary col-xs-10 col-md-6 col-lg-4" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
              Compre Agora
            </a>
            <!-- Collapse MetaMask -->
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
              <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasExampleLabel">Minha Carteira </h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
              </div>
              <div class="offcanvas-body">
                <div>
                  MetaMask é uma carteira de criptomoeda de software usada para interagir com o blockchain Ethereum. Ele permite que os usuários acessem sua carteira Ethereum por meio de uma extensão do navegador ou aplicativo móvel
                </div>
                <div class="col-2 mt-3 mx-auto">
                  <img src="./assets/images/MetaMask_Fox.svg.png" class="img-fluid" alt="MetaLogo">
                </div>
                <p class="col text-center font_meta fs-5">METAMASK</p>
                <div class="col pb-3 border-bottom my-5">
                  <div class="row">
                    <p class="col">Total</p>
                    <div class="col">
                      <span><i class="fab fa-ethereum fs-5 me-1"></i>0.05</span>
                      <span class="row text-muted mt-2">($150,67)</span>
                    </div>
                  </div>
                </div>
